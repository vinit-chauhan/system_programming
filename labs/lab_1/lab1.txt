...
int
prod(int (*function_maximum)(int*, int*), int (*function_max_array)(int*), int* parameter3, int* parameter4,
     int* parameter5) {
    // Store the maximum value out of parameter3 and parameter4.
    int max_of_parameter3_and_parameter4 = function_maximum(parameter3, parameter4);
